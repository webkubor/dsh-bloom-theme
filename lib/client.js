...
.dsh-bloom-dsh-state[data-state="latest"] {
  background: color-mix(in oklch, oklch(60% 0.12 150), transparent 86%);
  color: oklch(60% 0.12 150);
}
.dsh-bloom-dsh-state[data-state="err"] {
  background: color-mix(in oklch, oklch(58% 0.15 28), transparent 86%);
  color: oklch(58% 0.15 28);
}
...
.dsh-bloom-dsh-btn--primary {
  background: color-mix(in oklch, var(--bloom-accent, #c47b4a) 22%, transparent);
  border-color: color-mix(in oklch, var(--bloom-accent, #c47b4a) 50%, transparent);
  color: var(--bloom-accent, #c47b4a);
}
.dsh-bloom-dsh-btn--primary:hover {
  background: color-mix(in oklch, var(--bloom-accent, #c47b4a) 32%, transparent);
}
.dsh-bloom-dsh-hint {
  margin-top: 4px;
  padding: 4px 6px;
...
let dshLatestVersion = null;
let dshCheckPromise = null;
