...
<p align="center">
  <img src="assets/showcase/stats-card-sage.png" alt="Bloom coding stats card · Sage dark" width="49%" />
  <img src="assets/showcase/stats-card-amber.png" alt="Bloom coding stats card · Amber light" width="49%" />
  <sub>The stats card follows the current theme: accent / background / text all from theme tokens (sage dark + amber light shown). Generated by `/bloom stats --card`.</sub>
</p>
